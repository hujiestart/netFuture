  ...
  <body>
      <div class="panel panel-primary" style="margin:1%">
          <div class="panel-heading">
              <h3 class="panel-title">欢迎访问云猴千里眼系统！</h3>
          </div>
          <div class="panel-body">
              <p><h4>这是一个调用链跟踪与监控系统，目前能支持页面(Java/PHP/H5/APP)、PHP-API以及Global-API的请求跟踪。例：点击"开启本机调试"后，则本机发起的所有页面请求都将上报到千里眼监控中心，并最终在监控页面展示。<h4></p>
