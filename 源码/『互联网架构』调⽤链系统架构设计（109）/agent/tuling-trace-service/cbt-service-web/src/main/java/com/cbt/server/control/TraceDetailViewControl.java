...
import com.cbt.agent.trace.StackNodeVo;
...
import com.cbt.server.control.entity.JsTreeNode;
import com.cbt.server.control.entity.TraceNodeVo;
...
public class TraceDetailViewControl {
    ...
    public ModelAndView openTraceListView(String projectKey, String traceId, String rpcId) {
        ...
        for (StackNodeVo stackNodeVo : stackNodeVos) {
            if (!stackNodeVo.getId().equals("0")) {
                ...
                if (!map.containsKey(parentId)) {
                    logger.error("数据异常",
                            new CbtException(CBT.error_data,
