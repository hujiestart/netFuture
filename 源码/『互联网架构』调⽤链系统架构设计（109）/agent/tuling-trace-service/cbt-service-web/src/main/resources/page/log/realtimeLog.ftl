...
<html>
    ...
    <title>实时日志</title>
        ...
        <script type="text/javascript" src="${request.contextPath}/sockjs/sockjs-0.3.4.min.js"></script>
        <script>
            var websocket;
            var websocketUrl = "ws://localhost:9090/yunhou-hawkeye-web/webSocketServer?trace-debug-id=${page_debugId}";
            var sockJsUrl = "${request.contextPath}/sockjs/webSocketServer?trace-debug-id=${page_debugId}";
