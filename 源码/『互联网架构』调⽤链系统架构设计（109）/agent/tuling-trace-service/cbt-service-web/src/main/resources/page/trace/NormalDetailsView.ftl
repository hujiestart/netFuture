...
<#-- <script type="text/javascript" src="${request.contextPath}/jquery/jquery.min.js"></script>-->
    ...
    <script src="${request.contextPath}/highlight/highlight.pack.js"></script>
    <script>hljs.initHighlightingOnLoad();</script>
    <script src="http://cdn.bootcss.com/jquery-jsonview/1.2.3/jquery.jsonview.min.js"></script>

    <link rel="stylesheet" href="${request.contextPath}/highlight/styles/docco.css">
