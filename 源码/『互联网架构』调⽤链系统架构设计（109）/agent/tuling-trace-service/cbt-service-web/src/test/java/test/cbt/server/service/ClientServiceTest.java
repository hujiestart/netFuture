...
import com.cbt.server.common.NetUtils;
...
import test.cbt.server.BasiceTest;
...
//        login.setGatewayIp("10.201.9.1");
        ...
        login.setPlatform(CBT.platform.java.toString());
    ...
    public void httpLoginTest() throws IOException {
        URL url = new URL(
                "http://localhost:8080/api?method=client.login&sign=2adb203ef1069915f78d2219074d9bcb&appPath=F:\\git\\cbt-agent\\agent-bootstrap&platform=java&loginTime=1479883519276&appId=test_team&proKey=b71e2da2f7b74cba94ad008403ba594f&clientIp=10.201.9.121&clientMacAddress=44-37-e6-cc-67-10");
    ...
    public void postTEst() throws IOException {
        URL realUrl = new URL(
                "http://localhost:8080/api?method=client.login&sign=2adb203ef1069915f78d2219074d9bcb&appPath=F:\\git\\cbt-agent\\agent-bootstrap&platform=java&loginTime=1479883519276&appId=test_team&proKey=1b71e2da2f7b74cba94ad008403ba594f&clientIp=10.201.9.121&clientMacAddress=44-37-e6-cc-67-10");
        // 打开和URL之间的连接
