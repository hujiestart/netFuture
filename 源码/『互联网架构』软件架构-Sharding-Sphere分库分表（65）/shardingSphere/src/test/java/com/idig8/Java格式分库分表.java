...
import com.idig8.algorithm.PreciseModuloTableShardingAlgorithm;
...
public class Java格式分库分表 {
    ...
    public static void main(String[] args) throws SQLException {
        // 配置真实数据源
        Map<String, DataSource> dataSourceMap = new HashMap<String, DataSource>();//size 2 为两个数据库的datasource
