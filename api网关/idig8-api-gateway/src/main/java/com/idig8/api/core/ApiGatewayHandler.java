...
import com.idig8.api.common.Md5Util;
...
import com.idig8.api.common.ApiException;
import com.idig8.api.common.UtilJson;
import com.idig8.api.service.GoodsServiceImpl.Goods;
...
//        result.put("stack", out.toString());
     ...
     * @throws ApiException
     */
    private Object[] buildParams(ApiStore.ApiRunnable run, String paramJson, HttpServletRequest request, HttpServletResponse response, ApiRequest apiRequest)
            throws ApiException {
